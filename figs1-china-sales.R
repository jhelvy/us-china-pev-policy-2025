...
figs1 %>%
  ...
  labs(
    ...
    subtitle = "After peaking in 2017, internal combustion engine vehicle (ICEV) sales have declined, replaced by PEVs",
  ...
  geom_segment(
    data = data.frame(x = 2022.15, xend = 2023.4, y = 28.4, yend = 28.4),
